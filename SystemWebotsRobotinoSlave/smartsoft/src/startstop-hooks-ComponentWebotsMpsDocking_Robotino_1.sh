#!/bin/bash
#
# Start-Stop-Hooks for component ComponentWebotsMpsDocking_Robotino_1
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentWebotsMpsDocking.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsMpsDocking.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsMpsDocking.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsMpsDocking.sh post-stop
