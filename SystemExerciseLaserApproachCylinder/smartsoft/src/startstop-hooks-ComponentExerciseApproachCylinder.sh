#!/bin/bash
#
# Start-Stop-Hooks for component ComponentExerciseApproachCylinder
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentExerciseApproachCylinder.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentExerciseApproachCylinder.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentExerciseApproachCylinder.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentExerciseApproachCylinder.sh post-stop
