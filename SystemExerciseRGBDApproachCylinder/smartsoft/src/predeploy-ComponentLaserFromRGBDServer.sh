#!/bin/bash
#
# This script is run prior to deployment of component ComponentLaserFromRGBDServer
...
source $REFERENCED_PROJECT_ComponentLaserFromRGBDServer/smartsoft/src/predeploy.sh
