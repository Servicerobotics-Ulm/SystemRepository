#!/bin/bash
#
# This script is run prior to deployment of component ComponentRealSenseV2Server
...
source $REFERENCED_PROJECT_ComponentRealSenseV2Server/smartsoft/src/predeploy.sh
