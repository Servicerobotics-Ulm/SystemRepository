#!/bin/bash
#
# This script is run prior to deployment of component ComponentExerciseRGBDApproachCylinder
...
source $REFERENCED_PROJECT_ComponentExerciseRGBDApproachCylinder/smartsoft/src/predeploy.sh
