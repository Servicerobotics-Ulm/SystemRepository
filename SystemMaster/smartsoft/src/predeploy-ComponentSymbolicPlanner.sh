#!/bin/bash
#
# This script is run prior to deployment of component ComponentSymbolicPlanner
...
source $REFERENCED_PROJECT_ComponentSymbolicPlanner/smartsoft/src/predeploy.sh
