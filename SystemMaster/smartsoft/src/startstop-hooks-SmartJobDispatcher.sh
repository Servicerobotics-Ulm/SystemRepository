#!/bin/bash
#
# Start-Stop-Hooks for component SmartJobDispatcher
#
...
pre-start)
	...
	bash startstop-hooks-component-SmartJobDispatcher.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartJobDispatcher.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartJobDispatcher.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartJobDispatcher.sh post-stop
