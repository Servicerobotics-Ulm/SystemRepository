#!/bin/bash
#
# This script is run prior to deployment of component ComponentQtRobotConsole
...
source $REFERENCED_PROJECT_ComponentQtRobotConsole/smartsoft/src/predeploy.sh
