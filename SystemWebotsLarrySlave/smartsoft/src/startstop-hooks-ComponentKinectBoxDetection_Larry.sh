#!/bin/bash
#
# Start-Stop-Hooks for component ComponentKinectBoxDetection_Larry
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentKinectBoxDetection.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentKinectBoxDetection.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentKinectBoxDetection.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentKinectBoxDetection.sh post-stop
