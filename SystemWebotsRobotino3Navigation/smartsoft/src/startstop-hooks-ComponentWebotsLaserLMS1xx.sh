#!/bin/bash
#
# Start-Stop-Hooks for component ComponentWebotsLaserLMS1xx
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentWebotsLaserLMS1xx.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsLaserLMS1xx.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsLaserLMS1xx.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsLaserLMS1xx.sh post-stop
