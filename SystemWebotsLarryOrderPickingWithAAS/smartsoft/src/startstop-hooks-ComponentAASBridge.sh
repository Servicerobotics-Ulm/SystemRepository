#!/bin/bash
#
# Start-Stop-Hooks for component ComponentAASBridge
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentAASBridge.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentAASBridge.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentAASBridge.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentAASBridge.sh post-stop
