#!/bin/bash
#
# This script is run prior to deployment of component ComponentWebotsLaserLMS1xx
...
source $REFERENCED_PROJECT_ComponentWebotsLaserLMS1xx/smartsoft/src/predeploy.sh
