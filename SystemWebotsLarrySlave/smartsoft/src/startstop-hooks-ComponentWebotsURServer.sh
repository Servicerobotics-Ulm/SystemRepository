#!/bin/bash
#
# Start-Stop-Hooks for component ComponentWebotsURServer
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentWebotsURServer.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsURServer.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsURServer.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsURServer.sh post-stop
