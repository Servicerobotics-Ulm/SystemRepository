#!/bin/bash
#
# This script is run prior to deployment of component ComponentExerciseApproachCylinder
...
source $REFERENCED_PROJECT_ComponentExerciseApproachCylinder/smartsoft/src/predeploy.sh
