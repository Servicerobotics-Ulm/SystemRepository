#!/bin/bash
#
# Start-Stop-Hooks for component SmartURTestClient
#
...
pre-start)
	...
	bash startstop-hooks-component-SmartURTestClient.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartURTestClient.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartURTestClient.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartURTestClient.sh post-stop
