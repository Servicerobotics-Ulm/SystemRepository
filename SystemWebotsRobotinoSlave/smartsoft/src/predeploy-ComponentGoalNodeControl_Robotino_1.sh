#!/bin/bash
#
# This script is run prior to deployment of component ComponentGoalNodeControl_Robotino_1
...
source $REFERENCED_PROJECT_ComponentGoalNodeControl/smartsoft/src/predeploy.sh
