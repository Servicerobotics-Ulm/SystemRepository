#!/bin/bash
#
# Start-Stop-Hooks for component ComponentRMPBaseServer
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentRMPBaseServer.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentRMPBaseServer.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentRMPBaseServer.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentRMPBaseServer.sh post-stop
