#!/bin/bash
#
# This script is run prior to deployment of component ComponentWebotsPTUServer_Larry
...
source $REFERENCED_PROJECT_ComponentWebotsPTUServer/smartsoft/src/predeploy.sh
