#!/bin/bash
#
# This script is run prior to deployment of component ComponentWebotsConveyorBeltOpcua_Robotino_1
...
source $REFERENCED_PROJECT_ComponentWebotsConveyorBeltOpcua/smartsoft/src/predeploy.sh
