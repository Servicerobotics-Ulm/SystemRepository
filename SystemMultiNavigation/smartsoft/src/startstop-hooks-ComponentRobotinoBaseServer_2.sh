#!/bin/bash
#
# Start-Stop-Hooks for component ComponentRobotinoBaseServer_2
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentRobotinoBaseServer.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentRobotinoBaseServer.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentRobotinoBaseServer.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentRobotinoBaseServer.sh post-stop
