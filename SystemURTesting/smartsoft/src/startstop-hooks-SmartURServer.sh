#!/bin/bash
#
# Start-Stop-Hooks for component SmartURServer
#
...
pre-start)
	...
	bash startstop-hooks-component-SmartURServer.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartURServer.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartURServer.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartURServer.sh post-stop
