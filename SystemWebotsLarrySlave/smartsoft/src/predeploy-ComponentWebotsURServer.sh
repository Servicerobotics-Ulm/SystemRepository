#!/bin/bash
#
# This script is run prior to deployment of component ComponentWebotsURServer
...
source $REFERENCED_PROJECT_ComponentWebotsURServer/smartsoft/src/predeploy.sh
