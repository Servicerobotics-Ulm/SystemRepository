...
find ./SystemWebotsRobotinoSlavePathNav.deployment/ComponentKB_1.ini -type f -exec sed -z -i -e 's/\[kbChainedEntriesEventClient\]\nwiringName kbChainedEntriesEventClient\nserverName unknown\nserviceName unknown/\[kbChainedEntriesEventClient\]\nwiringName kbChainedEntriesEventClient\nserverName ComponentKB_Master\nserviceName kbEventServer/g' {} \;

find ./SystemWebotsRobotinoSlavePathNav.deployment/ComponentGoalNodeControl_1.ini -type f -exec sed -z -i -e 's/\[ShortestPathRequestServiceReq\]\nwiringName ShortestPathRequestServiceReq\nserverName unknown\nserviceName unknown\ninitialConnect false/\[ShortestPathRequestServiceReq\]\nwiringName ShortestPathRequestServiceReq\nserverName ComponentNavigationGraph\nserviceName ShortestPathRequestServiceAnsw\ninitialConnect true/g' {} \;

find ./SystemWebotsRobotinoSlavePathNav.deployment/ComponentGoalNodeControl_1.ini -type f -exec sed -z -i -e 's/\[NodeStatusUpdateServiceReq\]\nwiringName NodeStatusUpdateServiceReq\nserverName unknown\nserviceName unknown\ninitialConnect false/\[NodeStatusUpdateServiceReq\]\nwiringName NodeStatusUpdateServiceReq\nserverName ComponentNavigationGraph\nserviceName NodeStatusUpdateServiceAnsw\ninitialConnect true/g' {} \; 

mv SystemWebotsRobotinoSlavePathNav.deployment SystemWebotsRobotinoSlavePathNav_1.deployment

cp -r SystemWebotsRobotinoSlavePathNav_1.deployment SystemWebotsRobotinoSlavePathNav_2.deployment 

cd SystemWebotsRobotinoSlavePathNav_2.deployment 
...
find ./behaviorFiles/kb.smartTcl -type f -exec sed -i -e 's/(current-symbolic-position 0)/(current-symbolic-position 1)/g' {} \;

find ./behaviorFiles/startUp.smartTcl -type f -exec sed -i -e 's/localizationSetRobotPose 1350 1148 0/localizationSetRobotPose -1117 1031 0/g' {} \;
