#!/bin/bash
#
# Start-Stop-Hooks for component ComponentOpenRave_Larry
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentOpenRave.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentOpenRave.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentOpenRave.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentOpenRave.sh post-stop
