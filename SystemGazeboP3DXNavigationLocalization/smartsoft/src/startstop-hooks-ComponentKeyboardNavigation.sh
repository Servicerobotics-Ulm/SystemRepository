#!/bin/bash
#
# Start-Stop-Hooks for component ComponentKeyboardNavigation
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentKeyboardNavigation.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentKeyboardNavigation.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentKeyboardNavigation.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentKeyboardNavigation.sh post-stop
