#!/bin/bash
#
# This script is run prior to deployment of component ComponentWebotsRobotArm_Larry
...
source $REFERENCED_PROJECT_ComponentWebotsRobotArm/smartsoft/src/predeploy.sh
