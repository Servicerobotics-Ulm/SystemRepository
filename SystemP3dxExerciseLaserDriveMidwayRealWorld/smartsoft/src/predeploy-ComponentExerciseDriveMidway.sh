#!/bin/bash
#
# This script is run prior to deployment of component ComponentExerciseDriveMidway
...
source $REFERENCED_PROJECT_ComponentExerciseDriveMidway/smartsoft/src/predeploy.sh
