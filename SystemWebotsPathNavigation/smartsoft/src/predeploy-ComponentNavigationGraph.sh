#!/bin/bash
#
# This script is run prior to deployment of component ComponentNavigationGraph
...
source $REFERENCED_PROJECT_ComponentNavigationGraph/smartsoft/src/predeploy.sh
