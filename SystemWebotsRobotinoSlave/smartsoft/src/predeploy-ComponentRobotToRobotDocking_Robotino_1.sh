#!/bin/bash
#
# This script is run prior to deployment of component ComponentRobotToRobotDocking_Robotino_1
...
source $REFERENCED_PROJECT_ComponentRobotToRobotDocking/smartsoft/src/predeploy.sh
