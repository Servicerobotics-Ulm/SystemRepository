#!/bin/bash
#
# Start-Stop-Hooks for component ComponentVisualization_Larry
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentVisualization.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentVisualization.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentVisualization.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentVisualization.sh post-stop
