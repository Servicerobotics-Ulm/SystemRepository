#!/bin/bash
#
# Start-Stop-Hooks for component ComponentSymbolicPlanner
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentSymbolicPlanner.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentSymbolicPlanner.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentSymbolicPlanner.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentSymbolicPlanner.sh post-stop
