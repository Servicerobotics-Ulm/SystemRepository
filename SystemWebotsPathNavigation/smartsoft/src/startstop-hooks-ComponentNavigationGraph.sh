#!/bin/bash
#
# Start-Stop-Hooks for component ComponentNavigationGraph
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentNavigationGraph.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentNavigationGraph.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentNavigationGraph.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentNavigationGraph.sh post-stop
