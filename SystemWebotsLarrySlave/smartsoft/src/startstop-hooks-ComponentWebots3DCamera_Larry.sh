#!/bin/bash
#
# Start-Stop-Hooks for component ComponentWebots3DCamera_Larry
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentWebots3DCamera.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebots3DCamera.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebots3DCamera.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebots3DCamera.sh post-stop
