#!/bin/bash
#
# Start-Stop-Hooks for component ComponentWebotsPTUServer_Larry
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentWebotsPTUServer.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsPTUServer.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsPTUServer.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsPTUServer.sh post-stop
