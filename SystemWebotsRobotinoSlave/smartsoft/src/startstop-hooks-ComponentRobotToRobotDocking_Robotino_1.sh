#!/bin/bash
#
# Start-Stop-Hooks for component ComponentRobotToRobotDocking_Robotino_1
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentRobotToRobotDocking.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentRobotToRobotDocking.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentRobotToRobotDocking.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentRobotToRobotDocking.sh post-stop
