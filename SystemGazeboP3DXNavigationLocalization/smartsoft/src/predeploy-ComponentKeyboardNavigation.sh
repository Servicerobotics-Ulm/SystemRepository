#!/bin/bash
#
# This script is run prior to deployment of component ComponentKeyboardNavigation
...
source $REFERENCED_PROJECT_ComponentKeyboardNavigation/smartsoft/src/predeploy.sh
