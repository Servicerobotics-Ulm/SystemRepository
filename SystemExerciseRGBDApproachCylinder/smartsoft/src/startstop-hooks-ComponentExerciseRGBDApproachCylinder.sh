#!/bin/bash
#
# Start-Stop-Hooks for component ComponentExerciseRGBDApproachCylinder
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentExerciseRGBDApproachCylinder.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentExerciseRGBDApproachCylinder.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentExerciseRGBDApproachCylinder.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentExerciseRGBDApproachCylinder.sh post-stop
