#!/bin/bash
#
# This script is run prior to deployment of component ComponentSeq2SeqCom_Robotino_1
...
source $REFERENCED_PROJECT_ComponentSeq2SeqCom/smartsoft/src/predeploy.sh
