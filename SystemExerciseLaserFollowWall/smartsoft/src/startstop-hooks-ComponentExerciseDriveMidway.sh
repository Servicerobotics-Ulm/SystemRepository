#!/bin/bash
#
# Start-Stop-Hooks for component ComponentExerciseDriveMidway
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentExerciseDriveMidway.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentExerciseDriveMidway.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentExerciseDriveMidway.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentExerciseDriveMidway.sh post-stop
