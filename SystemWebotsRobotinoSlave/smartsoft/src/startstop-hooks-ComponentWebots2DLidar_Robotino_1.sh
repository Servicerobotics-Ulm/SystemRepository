#!/bin/bash
#
# Start-Stop-Hooks for component ComponentWebots2DLidar_Robotino_1
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentWebots2DLidar.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebots2DLidar.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebots2DLidar.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebots2DLidar.sh post-stop
