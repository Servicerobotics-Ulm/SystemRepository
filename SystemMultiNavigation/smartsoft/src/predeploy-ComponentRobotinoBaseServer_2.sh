#!/bin/bash
#
# This script is run prior to deployment of component ComponentRobotinoBaseServer_2
...
source $REFERENCED_PROJECT_ComponentRobotinoBaseServer/smartsoft/src/predeploy.sh
