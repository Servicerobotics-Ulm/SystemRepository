#!/bin/bash
#
# This script is run prior to deployment of component ComponentVisualization_Larry
...
source $REFERENCED_PROJECT_ComponentVisualization/smartsoft/src/predeploy.sh
