#!/bin/bash
#
# This script is run prior to deployment of component ComponentRackDetection_Larry
...
source $REFERENCED_PROJECT_ComponentRackDetection/smartsoft/src/predeploy.sh
