#!/bin/bash
#
# Start-Stop-Hooks for component ComponentExerciseFollowWall
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentExerciseFollowWall.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentExerciseFollowWall.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentExerciseFollowWall.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentExerciseFollowWall.sh post-stop
