#!/bin/bash
#
# This script is run prior to deployment of component ComponentExerciseFollowWall
...
source $REFERENCED_PROJECT_ComponentExerciseFollowWall/smartsoft/src/predeploy.sh
