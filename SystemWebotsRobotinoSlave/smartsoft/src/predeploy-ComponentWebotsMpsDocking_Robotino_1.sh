#!/bin/bash
#
# This script is run prior to deployment of component ComponentWebotsMpsDocking_Robotino_1
...
source $REFERENCED_PROJECT_ComponentWebotsMpsDocking/smartsoft/src/predeploy.sh
