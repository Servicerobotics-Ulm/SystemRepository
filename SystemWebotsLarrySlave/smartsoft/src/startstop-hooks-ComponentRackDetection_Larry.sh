#!/bin/bash
#
# Start-Stop-Hooks for component ComponentRackDetection_Larry
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentRackDetection.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentRackDetection.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentRackDetection.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentRackDetection.sh post-stop
