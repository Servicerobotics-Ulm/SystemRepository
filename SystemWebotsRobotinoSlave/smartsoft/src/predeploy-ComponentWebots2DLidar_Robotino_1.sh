#!/bin/bash
#
# This script is run prior to deployment of component ComponentWebots2DLidar_Robotino_1
...
source $REFERENCED_PROJECT_ComponentWebots2DLidar/smartsoft/src/predeploy.sh
