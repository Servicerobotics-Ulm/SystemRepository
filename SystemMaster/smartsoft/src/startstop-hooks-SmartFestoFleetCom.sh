#!/bin/bash
#
# Start-Stop-Hooks for component SmartFestoFleetCom
#
...
pre-start)
	...
	bash startstop-hooks-component-SmartFestoFleetCom.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartFestoFleetCom.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartFestoFleetCom.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartFestoFleetCom.sh post-stop
