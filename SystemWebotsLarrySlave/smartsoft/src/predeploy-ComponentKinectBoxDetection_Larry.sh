#!/bin/bash
#
# This script is run prior to deployment of component ComponentKinectBoxDetection_Larry
...
source $REFERENCED_PROJECT_ComponentKinectBoxDetection/smartsoft/src/predeploy.sh
