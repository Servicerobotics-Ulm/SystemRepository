#!/bin/bash
#
# This script is run prior to deployment of component ComponentWebots3DCamera_Larry
...
source $REFERENCED_PROJECT_ComponentWebots3DCamera/smartsoft/src/predeploy.sh
