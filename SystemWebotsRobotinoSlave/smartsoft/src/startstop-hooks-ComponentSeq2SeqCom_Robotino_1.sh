#!/bin/bash
#
# Start-Stop-Hooks for component ComponentSeq2SeqCom_Robotino_1
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentSeq2SeqCom.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentSeq2SeqCom.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentSeq2SeqCom.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentSeq2SeqCom.sh post-stop
