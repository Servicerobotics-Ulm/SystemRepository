#!/bin/bash
#
# Start-Stop-Hooks for component ComponentWebotsConveyorBeltOpcua_Robotino_1
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentWebotsConveyorBeltOpcua.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsConveyorBeltOpcua.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsConveyorBeltOpcua.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsConveyorBeltOpcua.sh post-stop
