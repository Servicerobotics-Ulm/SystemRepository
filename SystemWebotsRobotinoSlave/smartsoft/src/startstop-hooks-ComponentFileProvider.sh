#!/bin/bash
#
# Start-Stop-Hooks for component ComponentFileProvider
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentFileProvider.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentFileProvider.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentFileProvider.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentFileProvider.sh post-stop
