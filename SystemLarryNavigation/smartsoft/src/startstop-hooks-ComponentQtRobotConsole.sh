#!/bin/bash
#
# Start-Stop-Hooks for component ComponentQtRobotConsole
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentQtRobotConsole.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentQtRobotConsole.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentQtRobotConsole.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentQtRobotConsole.sh post-stop
